...
<body>
<c:set var="propertyId" value="${propertyId}"/>
...
<div class="container">
    ...
    <form action="propertyServlet" method="post" enctype="multipart/form-data">
        ...
        <select name="propertyType" id="propertyType">
            <option value="Terrace" <c:if test="${property.propertyType == 'Terrace'}">selected</c:if>>Terrace</option>
            <option value="Apartment" <c:if test="${property.propertyType == 'Apartment'}">selected</c:if>>Apartment</option>
            <option value="Villa" <c:if test="${property.propertyType == 'Villa'}">selected</c:if>>Villa</option>
        </select>

        <label for="propertyAddr">Property Address :</label>
        <textarea name="propertyAddr" id="propertyAddr" cols="30" rows="10">${property.propertyAddr}</textarea>

        <label for="propertyRate">Property Rate (RM)/Month :</label>
        <input type="number" name="propertyRate" id="propertyRate" value="${property.propertyRate}">
